  ...
  return (
    <div className="flex">
      ...
      <main className="flex-1 p-6 bg-gray-100 sm:ml-64">
        ...
        {/* Grid de tarjetas que representan diferentes funcionalidades de administración */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {/* Cada Card representa una sección diferente y abre un modal correspondiente al ser clickeado */}
          <Card
            title="Categorías"
        ...
        {/* Renderizado de modales para cada funcionalidad */}
